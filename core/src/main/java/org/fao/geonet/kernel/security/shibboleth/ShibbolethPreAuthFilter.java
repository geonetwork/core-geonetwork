 ...
 *
 * See
 * {@link org.springframework.security.web.authentication.preauth.RequestHeaderAuthenticationFilter}
 *
...
public class ShibbolethPreAuthFilter extends GenericFilterBean {
	...
	/**
	 * Check if there is a header with the username and then use it for
	 * authentication. If there is no header, but the user was authenticated by
	 * shibboleth, then just de-authenticate him
	 * 
