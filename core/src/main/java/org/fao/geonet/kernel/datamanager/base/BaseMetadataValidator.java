            ...
            if ((!failedAssert.isEmpty()) || (!failedSchematronVerification.isEmpty())) {
                ...
                while (reports.hasNext()) {
                    ...
                    if (schematronVerificationError != null) {
                        errorReport.append(errorReportSeperator).append("schematronVerificationError: " + schematronVerificationError.getTextTrim());
                        errorReportSeperator = ", ";
                    } else {
                        ...
                        while (errors.hasNext()) {
                            ...
                            if (msg.length() > 0) {
                                errorReport.append(errorReportSeperator).append(reportType).append(':').append(msg);
                                errorReportSeperator = ", ";
                            }
                        }
                    }
