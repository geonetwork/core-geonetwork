...
public class Settings {
    ...
    public static final String SYSTEM_INSPIRE_ATOM_SCHEDULE = "inspire/atom/atomSchedule";
    ...
    public static final String SYSTEM_USERFEEDBACK_ENABLE = "catalog/userFeedback/enable";
    public static final String SYSTEM_USER_LASTNOTIFICATIONDATE = "catalog/userFeedback/lastNotificationDate";
    ...
    public static final String SYSTEM_HIDEWITHHELDELEMENTS_ENABLE_LOGGING = "metadata/hidewithheldelements/enableLogging";
    ...
    public static final String SYSTEM_HARVESTER_ENABLE_EDITING = "harvester/config/enableEditing";
    public static final String SYSTEM_HARVESTER_ENABLE_PRIVILEGES_MANAGEMENT = "harvester/config/enablePrivilegesManagement";
    public static final String SYSTEM_HARVESTER_DISABLED_HARVESTER_TYPES = "harvester/config/disabledHarvesterTypes";
    ...
    public static final String SYSTEM_INSPIRE_ATOM_PROTOCOL = "inspire/atom/atomProtocol";
    ...
    public static final String SYSTEM_THREADEDINDEXING_MAXTHREADS = "catalog/index/maxthreads";
    public static final String SYSTEM_INDEX_INDEXINGTIMERECORDLINK = "catalog/index/indexingTimeRecordLink";
