...
public class Repositories {
    ...
    /**
     * clear the repositories template file - read the file and remove all <Repository> entries
     * except the GNSearchable one
     */
    public static boolean clearTemplate(ServiceContext context) {
        ...
        try {
            ...
            for (Element child : children) {
                if (child.getName().equals("Repository") && child.getAttributeValue("className").equals("org.jzkit.search.provider.z3950.Z3950Origin"))
                    continue;
    ...
    /**
     * Add a <Repository> element to the template file or replace one that is already present
     */
