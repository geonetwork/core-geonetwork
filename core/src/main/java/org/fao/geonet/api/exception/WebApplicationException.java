...
public class WebApplicationException extends LocalizedRuntimeException {
    ...
    /**
     * Constructs a new WebApplicationException exception with the specified detail message.
    ...
    /**
     * Constructs a new WebApplicationException exception with the specified detail message and
    ...
    /**
     * Constructs a new WebApplicationException exception with the specified cause and a
