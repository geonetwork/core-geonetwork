 ...
 *
 * To avoid a need to wrap JDOM1 Element everywhere in GN, these methods are adapted to take a (JDOM1) Element as
 * parameter instead.
 *
 * Adapted code from https://github.com/hunterhacker/jdom/blob/master/core/src/java/org/jdom2/Element.java.
 *
 * When GeoNetwork upgrades to use JDOM2, this class becomes obsolete. Its usages should then be replaced by directly
 * using the same methods on your JDOM Elements.
 *
