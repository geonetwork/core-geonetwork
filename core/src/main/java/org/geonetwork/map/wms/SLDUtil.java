...
public class SLDUtil {
    ...
    /**
     * Insert a new filter in all rules of the sld document. For each rule, the ogc:Filter ellement
     * is added if not exist, or merge with an ogc:And tag with the giver filter.
     *
