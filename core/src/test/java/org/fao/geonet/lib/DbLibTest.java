 ...
 */
public class DbLibTest extends AbstractCoreIntegrationTest {
    ...
    public void testInsertData() throws Exception {
        TransactionlessTesting.get().run(new TestTask() {
            ...
            public void run() throws Exception {
                ...
                String filePath = getClassFile(DbLibTest.class).getParentFile().getPath();
                String filePrefix = "db-test-";
                new DbLib().insertData(null, context, getWebappDir(DbLibTest.class), filePath, filePrefix);
            }
        });
