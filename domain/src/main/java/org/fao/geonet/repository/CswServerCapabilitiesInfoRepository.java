 ...
 * @author Jesse
 */
public interface CswServerCapabilitiesInfoRepository extends GeonetRepository<CswServerCapabilitiesInfo, Integer>,
        JpaSpecificationExecutor<CswServerCapabilitiesInfo> {
    /**
