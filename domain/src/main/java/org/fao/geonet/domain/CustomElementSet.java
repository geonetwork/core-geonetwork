...
/**
 * Csw custom element set.  This is part of the CSW specification related to what elements
 * are returned by GetRecords and GetRecordById.
 *
 * @author Jesse
 */
@Entity
...
public class CustomElementSet {
    ...
    /**
     * Get the xpath of the element to include in the element set.
