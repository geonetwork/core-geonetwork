...
public class ResourceUploadTask extends GeonetEntity {
    ...
    /**
     * Returns the deterministic active claim key for a metadata UUID and
     * resolved filename.
     *
     * <p>The value is a SHA-256 digest of the length-delimited UUID and filename.
     * The database uniqueness constraint on this value prevents upload tasks
     * sharing the same database from holding the same active filename claim.
     *
