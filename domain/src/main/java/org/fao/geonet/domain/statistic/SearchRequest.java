 ...
 *
 * <p>
 *     When creating a SearchRequest and its parameters all the parameters and the search request must be
 *     saved individually because a limitation of JPA means that SearchRequest can't cascade operations from
 *     SearchRequest to the params.
 * </p>
 * 
 * @author Jesse
 */
...
public class SearchRequest {
     ...
     * Save the parameters.
     *
     * @param repo the repository to use to save.
     */
    public void persistParams(SearchRequestParamRepository repo) {
        List<SearchRequestParam> savedParams = new ArrayList<SearchRequestParam>();
        for (SearchRequestParam searchRequestParam : getParams()) {
            final SearchRequestParam savedParam = repo.save(searchRequestParam);
            savedParam.setRequest(this);
            savedParams.add(savedParam);
        }
