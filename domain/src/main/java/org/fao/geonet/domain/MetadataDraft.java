...
public class MetadataDraft extends IMetadata {
    ...
    public static final String METADATA_CATEG_JOIN_TABLE_NAME_DRAFT = METADATA_CATEG_JOIN_TABLE_NAME + "Draft";
    ...
    @JoinTable(name = METADATA_CATEG_JOIN_TABLE_NAME_DRAFT, 
            joinColumns = @JoinColumn(name = "metadataId"), 
            inverseJoinColumns = @JoinColumn(name = METADATA_CATEG_JOIN_TABLE_CATEGORY_ID))
    @Nonnull
