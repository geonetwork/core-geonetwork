...
/**
 * Represents an address. This is a JPA Entity object and is contained in a
 * database table.
 * 
 * @author Jesse
 */
public class Address extends GeonetEntity {
	private static final long serialVersionUID = 557101670135536133L;
	...
	/**
	 * Id of the address. This is automatically generated so when creating a new
	 * object leave this blank and allow the database or JPA set the value for
	 * you on save.
	 */
	public int getId() {
		return _id;
	...
	/**
	 * Set the id of the address. This is automatically generated so when
	 * creating a new object leave this blank and allow the database or JPA set
	...
	/**
	 * Get the address line of the address. This is typically the street name
	 * and number but varies depending on the type of address.
	 */
	...
	/**
	 * Set the address data. See {@link #getAddress()} for details on what the
	 * "address" is.
	 * 
	 * @param address
