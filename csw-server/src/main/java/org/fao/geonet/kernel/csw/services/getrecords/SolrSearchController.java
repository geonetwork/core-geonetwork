...
public class SolrSearchController implements ISearchController {
    @Override
    public Pair<Element, Element> search(ServiceContext context, int startPos, int maxRecords, ResultType resultType, String outSchema, ElementSetName setName, Element filterExpr, String filterVersion, Element request, Set<String> elemNames, String typeName, int maxHitsFromSummary, String cswServiceSpecificContraint, String strategy) throws CatalogException {
        throw new NotImplementedException("CSW not implemented for Solr backend yet");
    }
