 ...
 *
 * Table 69 — URIs for well known metadata standards URI Description http://www.opengis.net/wms
 *                       WMS capability document, all current versions http://www.opengis.net/wfs
 *                         WFS capability document, versions 1.0 and 1.1
 ...
 * http://www.opengis.net/cat/csw                        CSW capability document, versions 2.0.0 and
 * 2.0.1 http://www.opengis.net/cat/csw/2.0.2 CSW capability document, version 2.0.2
 * http://www.fgdc.gov/metadata/csdgm Content Standard for Digital Geospatial Metadata (CSDGM),
 * Vers. 2 (FGDC-STD-001-1998) http://www.auslig.gov.au/dtd/anzmeta-1.3.dtd          Australian
 * Spatial Data Infrastructure Standard http://www.isotc211.org/schemas/2005/gmd/
 * ISO19139 document http://metadata.dod.mil/mdr/ns/DDMS/1.3/              DEPARTMENT OF DEFENSE
