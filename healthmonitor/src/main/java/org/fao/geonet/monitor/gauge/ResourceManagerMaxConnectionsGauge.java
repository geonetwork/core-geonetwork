...
/**
 * Gauge that gets the maximum number possible connections as reported by the ResourceProvider. If
 * unable to access information or if the number is null (Like in case of JNDI) Integer.MIN_VALUE
 * will be reported.
 *
