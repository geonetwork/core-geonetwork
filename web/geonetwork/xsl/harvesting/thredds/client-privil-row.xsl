...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!-- ============================================================================================= -->
	<!-- === Generate a table row for the harvesting's thredds privilege list -->
	<!-- ============================================================================================= -->

	<xsl:template match="/root/group">

		<tr id="thredds.group.{@id}">
			...
			<td class="padded" align="center">
				<!--button class="content" onclick="harvesting.thredds.removeGroupRow('csw.group.{@id}')">
					<xsl:value-of select="/root/strings/remove"/>
				</button-->

				<!-- Yet another fix for IE -->

				<a href="javascript:harvesting.thredds.removeGroupRow('csw.group.{@id}')">
					<xsl:value-of select="/root/strings/remove"/>
				</a>		
			</td>
		</tr>
