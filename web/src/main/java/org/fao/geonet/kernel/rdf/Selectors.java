...
public class Selectors {
	...
	public static Selector languages(Selector textSelector) {
	    return new Selector(format("lang({0}) as \"language\"", textSelector.id), ID.getPath()+", "+textSelector.getPath(), Selectors.SKOS_NAMESPACE);
	}
