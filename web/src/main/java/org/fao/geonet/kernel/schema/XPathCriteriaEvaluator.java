...
/**
 * Evaluate the value of a SchematronCriteria as an xpath against the document to see if the xpath
 * either:
 * <ul>
 *     <li>Returns true</li>
...
public class XPathCriteriaEvaluator implements SchematronCriteriaEvaluator {
    ...
    /**
     * Construct {@link SchematronCriteria} with a value and
     * {@link SchematronCriteriaType#XPATH}.
     * <p/>
     * All of the text values needs to result in successes for the criteria to pass.
     *
     * @param textToMatch one or more text objects.
     * @return a {@link SchematronCriteria} object
     */
     ...
     * @return a {@link SchematronCriteria}
     */
