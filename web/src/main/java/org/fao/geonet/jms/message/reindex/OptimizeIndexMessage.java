 ...
 * @author jose garcia
 */
public class OptimizeIndexMessage extends Message {
    ...
    public OptimizeIndexMessage decode(String xml) {
        XMLDecoder decoder = new XMLDecoder(new ByteArrayInputStream(xml.getBytes()));
        OptimizeIndexMessage optimizeIndexMessage = (OptimizeIndexMessage)decoder.readObject();
        decoder.close();
        return optimizeIndexMessage;
    }
}