 ...
 */
public class SystemConfigurationMessage extends Message {
    ...
    public SystemConfigurationMessage decode(String xml) {
        XMLDecoder decoder = new XMLDecoder(new ByteArrayInputStream(xml.getBytes()));
        SystemConfigurationMessage message = (SystemConfigurationMessage)decoder.readObject();
        decoder.close();
        return message;
    }
}