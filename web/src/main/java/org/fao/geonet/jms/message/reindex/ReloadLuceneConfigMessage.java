 ...
 * @author jose garcia
 */
public class ReloadLuceneConfigMessage extends Message {
    ...
    public ReloadLuceneConfigMessage decode(String xml) {
        XMLDecoder decoder = new XMLDecoder(new ByteArrayInputStream(xml.getBytes()));
        ReloadLuceneConfigMessage reloadLuceneConfigMessage = (ReloadLuceneConfigMessage)decoder.readObject();
        decoder.close();
        return reloadLuceneConfigMessage;
    }
}