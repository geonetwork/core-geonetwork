	...
	public static Element process(String id, String process, boolean save,
		...
		if (info == null) {
	        ...
	        for (Element param : children) {
	        	// Add extra metadata
	            if (param.getName().equals("extra_metadata_uuid") && !param.getTextTrim().equals("")) {
	            	String extraMetadataId = dataMan.getMetadataId(dbms, param.getTextTrim());
