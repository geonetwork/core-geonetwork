...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template mode="RefSystem" match="int:GM03_2Core.Core.MD_ReferenceSystem">
    ...
    <xsl:template mode="MdIdent" match="int:GM03_2Comprehensive.Comprehensive.RS_Identifier|int:GM03_2Core.Core.RS_Identifier">
        <gmd:RS_Identifier>
            <xsl:apply-templates mode="MdIdent"/>
        </gmd:RS_Identifier>
    </xsl:template>
