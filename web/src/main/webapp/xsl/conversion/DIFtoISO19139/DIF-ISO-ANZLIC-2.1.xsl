          ...
          <xsl:for-each select="dif:Use_Constraints">
            <gmd:resourceConstraints>
              <gmd:MD_LegalConstraints>
				...
				<gmd:characterSet>
					<gmd:MD_CharacterSetCode xmlns:srv="http://www.isotc211.org/2005/srv" codeListValue="utf8" codeList="http://asdd.ga.gov.au/asdd/profileinfo/gmxCodelists.xml#MD_CharacterSetCode"/>
				</gmd:characterSet>
