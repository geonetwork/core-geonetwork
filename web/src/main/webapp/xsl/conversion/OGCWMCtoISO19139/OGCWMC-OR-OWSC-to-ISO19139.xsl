            ...
            <gmd:RS_Identifier>
              <gmd:code>
                <gco:CharacterString><xsl:value-of select="
                    ...
                    ows-context:General/ows:BoundingBox/@crs"/></gco:CharacterString>
              </gmd:code>
            </gmd:RS_Identifier>
          </gmd:referenceSystemIdentifier>
        </gmd:MD_ReferenceSystem>
        ...
        <gmd:MD_Distribution>
          <gmd:transferOptions>
            <gmd:MD_DigitalTransferOptions>
              ...
              <xsl:for-each select="wmc:LayerList/wmc:Layer|ows-context:ResourceList/ows-context:Layer">
                <gmd:onLine>
                  ...
                  <xsl:variable name="layerProtocol" select="if (ows:Server/@service) then ows:Server/@service else 'OGC:WMS'" />
                  <gmd:CI_OnlineResource>
                    <gmd:linkage>
                      <gmd:URL>
