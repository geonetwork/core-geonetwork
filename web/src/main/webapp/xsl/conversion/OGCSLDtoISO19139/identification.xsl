...
<xsl:stylesheet version="2.0" xmlns ="http://www.isotc211.org/2005/gmd"
	...
	<xsl:template match="*" mode="DataIdentification">
		...
		<citation>
			<CI_Citation>
				<title>
					<gco:CharacterString><xsl:value-of select="sld:NamedLayer/sld:UserStyle/sld:Title"/></gco:CharacterString>
				</title>
			</CI_Citation>
		</citation>
		...
		<abstract>
			<gco:CharacterString><xsl:value-of select="sld:NamedLayer/sld:UserStyle/sld:Abstract"/></gco:CharacterString>
		</abstract>
