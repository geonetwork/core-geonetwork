    ...
    <xsl:template match="/record">
        ...
        <mdb:MD_Metadata xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
            ...
            <mdb:dateInfo>
                <cit:CI_Date>
                    <cit:date>
                        <gco:DateTime><xsl:value-of select="date_publication"/></gco:DateTime>
                    </cit:date>
                    <cit:dateType>
            ...
            <mdb:identificationInfo>
                <mri:MD_DataIdentification>
                    ...
                    <xsl:for-each select="organismes">
                        <xsl:variable name="orgIndex" select="Indice" />
                        <mri:pointOfContact>
                            <cit:CI_Responsibility>
                                <cit:role>
                                ...
                                <cit:party>
                                    <cit:CI_Organisation>
                                        ...
                                        <xsl:for-each select="/record/authors[./Indice_organisme=$orgIndex]">
                                            <cit:individual>
                                                <cit:CI_Individual>
                                                    <cit:name>
                                                        <gco:CharacterString>
...
<!--                    </mri:resourceMaintenance>-->
                    ...
                    <mri:graphicOverview>
                        <mcc:MD_BrowseGraphic>
                            <mcc:fileName>
                                <gco:CharacterString><xsl:value-of select="illustration_image_URL" /></gco:CharacterString>
                            </mcc:fileName>
                            <mcc:fileDescription>
                                <gco:CharacterString><xsl:value-of select="illustration_image_caption" /></gco:CharacterString>
                            </mcc:fileDescription>
                        </mcc:MD_BrowseGraphic>
                    </mri:graphicOverview>
                </mri:MD_DataIdentification>
