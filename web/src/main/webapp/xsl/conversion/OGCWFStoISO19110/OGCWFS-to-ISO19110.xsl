...
-->
	...
	<xsl:template match="xsi:element">
		<gfc:featureType>
			<gfc:FC_FeatureType>
				<gfc:typeName>
					<gco:LocalName><xsl:value-of select="@type"/></gco:LocalName>
				</gfc:typeName>
				<gfc:definition>
					<gco:CharacterString/>
				</gfc:definition>
		...
		<gfc:carrierOfCharacteristics>
			<gfc:FC_FeatureAttribute>
					...
					<gco:Multiplicity>
						<gco:range>
							<gco:MultiplicityRange>
								...
								<gco:upper>
									<xsl:choose>
										<xsl:when test="@maxOccurs"><gco:UnlimitedInteger isInfinite="false"><xsl:value-of select="@maxOccurs"/></gco:UnlimitedInteger></xsl:when>
										<xsl:otherwise><gco:UnlimitedInteger isInfinite="true" xsi:nil="true"/></xsl:otherwise>
									</xsl:choose>
								</gco:upper>
							</gco:MultiplicityRange>
						</gco:range>
				...
				<gfc:valueType>
					<gco:TypeName>
						<gco:aName>
							<gco:CharacterString><xsl:value-of select="@type"></xsl:value-of></gco:CharacterString>
						</gco:aName>
					</gco:TypeName>
				</gfc:valueType>
			</gfc:FC_FeatureAttribute>
