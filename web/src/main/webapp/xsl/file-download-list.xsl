		...
		<xsl:call-template name="formLayout">
			...
			<xsl:with-param name="content">
				...
				<div id="downloadlist">
					<table align="center">
						<tr>
							<th class="padded"><xsl:value-of select="/root/gui/strings/type"/></th>
							<th class="padded"><xsl:value-of select="/root/gui/strings/downloadSelect"/></th>
							<th class="padded"><xsl:value-of select="/root/gui/strings/descriptionTab"/></th>
							<th class="padded" align="right"><xsl:value-of select="/root/gui/strings/sizeBytes"/></th>
							<th class="padded"><xsl:value-of select="/root/gui/strings/dateModified"/></th>
						</tr>
						...
						<tr width="100%">
							<td align="center" colspan="6">
								<button class="content" onclick="doDownload('{/root/response/id}')"><xsl:value-of select="/root/gui/strings/downloadSelected"/></button>
								&#160;
								<button class="content" onclick="doDownload('{/root/response/id}', 'all')"><xsl:value-of select="/root/gui/strings/downloadThemAll"/></button>
							</td>
						</tr>
