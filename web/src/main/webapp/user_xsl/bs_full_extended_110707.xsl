...
<!-- Das Textende muss je nach Version angepasst werden: Komplett / Erweitert / Einfach -->													
													<td valign="top" height="26" align="left" width="647" style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 20px;font-style:normal; font-weight:normal; color:#666666; text-decoration:none; line-height:26px">Metadatenkatalog - Erweitert</td> 		
												</tr>
											</tbody>
										</table>
									</td>
