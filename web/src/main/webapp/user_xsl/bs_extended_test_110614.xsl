										...
										<table width="692" border="0" cellpadding="0" cellspacing="0">
											<tbody>
												...
												<tr>
													...
													<td style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 20px;font-style:normal; font-weight:normal; color:#666666; text-decoration:none; line-height:26px" width="647" align="left" height="26" valign="top">Metadatenkatalog</td>
												</tr>
											</tbody>
										</table>
									</td>
													...
													<td class="text" width="*" align="left" valign="top">
														...
														<table width="490" border="0" cellpadding="0" cellspacing="0" style="font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px; font-style: normal; color: #000000; text-decoration: none; line-height: 17px;">
															...
															<tbody>
																...
																<tr>
																	<td height="50" colspan="2" class="text" valign="middle">
																		<a href="javascript:window.print();" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 11px; color: #CC9933; font-style: normal; text-decoration: none; line-height: 14px;">Drucken</a>
																	</td>
																</tr>
																<tr>
																	<td colspan="2">
...
<!-- Basisinformation - full-->
	...
	<!-- Thematik - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:topicCategory[1]/gmd:MD_TopicCategoryCode"/>
					<br/><br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:topicCategory[2]/gmd:MD_TopicCategoryCode"/>
					<br/><br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:topicCategory[3]/gmd:MD_TopicCategoryCode"/>
					<br/><br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:topicCategory[4]/gmd:MD_TopicCategoryCode"/>
				</td>
			</tr>
	<!-- Schlüsselwörter - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords[1]/gmd:MD_Keywords/gmd:keyword/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString"/>
					<br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords[2]/gmd:MD_Keywords/gmd:keyword/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString"/>
					<br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords[3]/gmd:MD_Keywords/gmd:keyword/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[2]"/>
					<br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords[4]/gmd:MD_Keywords/gmd:keyword/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString[DE]"/>
				</td>
			</tr>
	<!-- Rechtliche Einschränkungen - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:resourceConstraints[1]/che:CHE_MD_LegalConstraints/gmd:otherConstraints/gco:CharacterString"/>
					<br/><br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:resourceConstraints[2]/che:CHE_MD_LegalConstraints/gmd:otherConstraints/gco:CharacterString"/>
					<br/><br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:resourceConstraints[3]/che:CHE_MD_LegalConstraints/gmd:otherConstraints/gco:CharacterString"/>
					<br/><br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:resourceConstraints[4]/che:CHE_MD_LegalConstraints/gmd:otherConstraints/gco:CharacterString"/>
				</td>
			</tr>
...
<!-- Vertrieb-->
	...
	<!-- Online Darstellung - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine[1]/gmd:CI_OnlineResource/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;&#45;&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine[1]/gmd:CI_OnlineResource/gmd:description/gco:CharacterString"/>
				<br/>
				<!-- URL - full-->
				<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine[1]/gmd:CI_OnlineResource/gmd:linkag/gmd:URL"/>
				<br/>
				<br/>
				<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine[2]/gmd:CI_OnlineResource/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;&#45;&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine[2]/gmd:CI_OnlineResource/gmd:description/gco:CharacterString"/>
				<br/>
				<!-- URL - full-->
				<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine[2]/gmd:CI_OnlineResource/gmd:linkag/gmd:URL"/>
				</td>
			</tr>	
	<!-- Adresse Vertrieb - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					...
					<br/>
					<a href="{gmd:distributionInfo/gmd:MD_Distribution/gmd:distributor/gmd:MD_Distributor/gmd:distributorContact/che:CHE_CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/che:PT_FreeURL/che:URLGroup/che:LocalisedURL/text()}" target="_new">
						<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributor/gmd:MD_Distributor/gmd:distributorContact/che:CHE_CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:onlineResource/gmd:CI_OnlineResource/gmd:linkage/che:PT_FreeURL/che:URLGroup/che:LocalisedURL/text()"/>
					</a>
					<br/>
	...
	<!-- Abgabeformat - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat[1]/gmd:MD_Format/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat[1]/gmd:MD_Format/gmd:version/gco:CharacterString"/>
					<br/>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat[2]/gmd:MD_Format/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat[2]/gmd:MD_Format/gmd:version/gco:CharacterString"/>
					<br/>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat[3]/gmd:MD_Format/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat[3]/gmd:MD_Format/gmd:version/gco:CharacterString"/>
					<br/>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat[4]/gmd:MD_Format/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat[4]/gmd:MD_Format/gmd:version/gco:CharacterString"/>
				</td>
			</tr>	
			<tr>
				<td colspan="2" class="text" bgcolor="#f1f1f1" valign="TOP">
