...
<!-- Ausdehung - simple-->
			...
			<tr>
				<td colspan="2" class="text" bgcolor="#ffffff">
					...
					<iframe src="http://www.stadtplan.bs.ch/geoviewer/index.php?instance=mashup_simple&amp;theme=16&amp;cps=613766.86,267348.08,100000&amp;layers=citymap_grey_lk100_25" frameborder="no" scrolling="no" width="500" height="400" style="border-width: 0px; border-style: solid; margin:0; padding:0;">
...
<!-- Vertrieb-->
	...
	<!-- Online Darstellung - full-->
			<tr>
				<td class="text" width="30%" bgcolor="silver" valign="TOP">
					<b>
						<xsl:value-of select="string($label/labels/element[@name='gmd:onLine']/label)"/>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
				<!-- Funktion - full-->
				<xsl:call-template name="codelist">
				  <xsl:with-param name="code" select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource[1]//gmd:function/gmd:CI_OnLineFunctionCode/@codeListValue"/>
				  <xsl:with-param name="path" select="string('gmd:CI_OnLineFunctionCode')"/>
				</xsl:call-template>
				 <br/>
				<!-- Bezeichnung - full-->
	...
	<!-- Abgabeformat - full-->
			<tr>
				<td class="text" width="30%" bgcolor="silver" valign="TOP">
					<b>
						<xsl:value-of select="string($label/labels/element[@name='md:distributionFormat']/label)"/>
					</b>
				</td>
				<td bgcolor="#ffffff" valign="TOP">
					<!-- Bezeichnung - full-->
