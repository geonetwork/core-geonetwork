...
<!-- Basisinformation - full-->
	...
	<!-- Schlüsselwörter - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword[1]/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString"/>
					<br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword[2]/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString"/>
					<br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword[3]/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString"/>
					<br/>
					<xsl:value-of select="gmd:identificationInfo/che:CHE_MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:keyword[4]/gmd:PT_FreeText/gmd:textGroup/gmd:LocalisedCharacterString"/>
				</td>
			</tr>
...
<!-- Vertrieb-->
	...
	<!-- Online Darstellung - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource[1]//gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource[1]//gmd:description/gco:CharacterString"/>
				<br/>
				<!-- URL - full-->
				<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine/gmd:CI_OnlineResource[1]//gmd:linkag/gmd:URL"/>
				</td>
			</tr>	
	...
	<!-- Abgabeformat - full-->
			<tr>
				...
				<td bgcolor="#ffffff" valign="TOP">
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format[1]/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format[1]/gmd:version/gco:CharacterString"/>
					<br/>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format[2]/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format[2]/gmd:version/gco:CharacterString"/>
					<br/>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format[3]/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format[3]/gmd:version/gco:CharacterString"/>
					<br/>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format[4]/gmd:name/gco:CharacterString"/>
					<xsl:text disable-output-escaping="no">&#160;</xsl:text>
					<xsl:value-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format[4]/gmd:version/gco:CharacterString"/>
				</td>
			</tr>	
			<tr>
				<td colspan="2" class="text" bgcolor="#f1f1f1" valign="TOP">
