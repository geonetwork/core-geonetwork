-- August 2013
-- Contain changes about new Settings table structure
...
INSERT INTO HarvesterSettings SELECT * FROM Settings WHERE id > 965 AND parentId > 2;
-- Drop harvester config from Settings table
DELETE FROM Settings WHERE id > 965;
...
-- Sextant specific settings / start

UPDATE Settings SET name = 'system/wiki/markup', datatype = 0 WHERE id = 961;
UPDATE Settings SET name = 'system/wiki/output', datatype = 0 WHERE id = 962;
UPDATE Settings SET name = 'system/wiki/mefoutput', datatype = 0 WHERE id = 963;
UPDATE Settings SET name = 'system/wysiwyg/enable', datatype = 2 WHERE id = 965;


UPDATE Settings SET parentId = null;

DELETE FROM Settings WHERE id = 960;
DELETE FROM Settings WHERE id = 964;


-- Delete old GN 2.6 settings not used 
DELETE FROM Settings WHERE id = 123;
DELETE FROM Settings WHERE id = 124;
DELETE FROM Settings WHERE id = 125;
DELETE FROM Settings WHERE id = 126;
DELETE FROM Settings WHERE id = 127;
DELETE FROM Settings WHERE id = 128;
DELETE FROM Settings WHERE id = 129;
DELETE FROM Settings WHERE id = 130;
DELETE FROM Settings WHERE id = 155;
DELETE FROM Settings WHERE id = 160;
DELETE FROM Settings WHERE id = 161;
DELETE FROM Settings WHERE id = 162;
DELETE FROM Settings WHERE id = 163;
DELETE FROM Settings WHERE id = 140;
DELETE FROM Settings WHERE id = 141;
DELETE FROM Settings WHERE id = 150;
DELETE FROM Settings WHERE id = 151;
DELETE FROM Settings WHERE id = 152;
DELETE FROM Settings WHERE id = 153;
DELETE FROM Settings WHERE id = 154;
DELETE FROM Settings WHERE id = 955;

-- Sextant specific settings / end
...
UPDATE StatusValues SET displayorder = 4 WHERE id = 2;
UPDATE StatusValues SET displayorder = 5 WHERE id = 3;
UPDATE StatusValues SET displayorder = 2 WHERE id = 4;
UPDATE StatusValues SET displayorder = 3 WHERE id = 5;
