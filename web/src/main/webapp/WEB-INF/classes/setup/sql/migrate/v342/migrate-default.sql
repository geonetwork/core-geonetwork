...
UPDATE Settings SET name = 'system/localrating/enable', datatype = 0, value = 'off' WHERE id = 2110 and value = 'n';
UPDATE Settings SET name = 'system/localrating/enable', datatype = 0, value = 'basic' WHERE id = 2110 and value = 'y';
