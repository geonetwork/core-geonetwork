 ...
 */
public class DetailViewTabbedMigration extends JsonDatabaseMigration {
    ...
    protected Map<String, String> setUpNewSettingValues() {
        ...
        fieldsToUpdate.put("/mods/recordview/mdViewTemplate",
            "\"recordView.html\"");
        fieldsToUpdate.put("/mods/recordview/mdDefaultTab",
            "\"general\"");
