...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:gn-fn-iso19139.sdn-product="http://geonetwork-opensource.org/xsl/functions/profiles/iso19139.sdn-product"
  ...
  <xsl:template name="get-iso19139.sdn-product-geopublisher-config"/>
</xsl:stylesheet>
