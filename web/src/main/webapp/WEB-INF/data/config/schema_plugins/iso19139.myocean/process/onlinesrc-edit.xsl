                ...
                <xsl:otherwise>
                    <gmd:distributionInfo>
                        <gmd:MD_Distribution>
                            ...
                            <xsl:copy-of select="gmd:distributionInfo/gmd:MD_Distribution/gmd:distributor[gmd:MD_Distributor//gmd:onLine[1]/gmd:CI_OnlineResource/gmd:linkage/gmd:URL != $url]"/>
