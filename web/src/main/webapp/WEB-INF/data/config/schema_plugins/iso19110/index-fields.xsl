	...
	<xsl:template match="/">
		...
		<Document locale="{$langCode}">
			...
			<Field name="_defaultTitle"
				string="{/gfc:FC_FeatureCatalogue/gmx:name/gco:CharacterString|/gfc:FC_FeatureType/gfc:typeName/gco:LocalName}"
				store="true" index="true"/>

			<!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
			<!-- === Title === -->
			<xsl:apply-templates
				select="/gfc:FC_FeatureCatalogue/gmx:name/gco:CharacterString|/gfc:FC_FeatureType/gfc:typeName/gco:LocalName">
			...
			<Field name="_title"
				string="{string(/gfc:FC_FeatureCatalogue/gmx:name/gco:CharacterString|/gfc:FC_FeatureType/gfc:typeName/gco:LocalName)}"
			...
			<!-- === Abstract === -->
			<xsl:apply-templates
				select="/gfc:FC_FeatureCatalogue/gmx:scope/gco:CharacterString|/gfc:FC_FeatureType/gfc:definition/gco:CharacterString">
