...
-->
	...
	<sch:pattern>
		...
		<sch:rule context="//gmd:MD_LegalConstraints[gmd:accessConstraints/gmd:MD_RestrictionCode/@codeListValue='otherRestrictions']
			...
			<sch:let name="access" value="(not(gmd:otherConstraints) or not(string(gmd:otherConstraints/gco:CharacterString) or string((gmd:otherConstraints//gmd:LocalisedCharacterString)[1])) or gmd:otherConstraints/@gco:nilReason='missing')"/>
			<sch:assert
				test="$access = false()"
				>
