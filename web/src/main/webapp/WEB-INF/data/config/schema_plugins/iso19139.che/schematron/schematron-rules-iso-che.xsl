...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
	  ...
	  <!--RULE -->
<xsl:template match="//che:CHE_MD_DataIdentification" priority="1000" mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//che:CHE_MD_DataIdentification"/>
      <xsl:variable name="emptyGeoId"
                    select="che:basicGeodataID/gco:CharacterString!='' and (not(che:basicGeodataIDType) or che:basicGeodataIDType/che:basicGeodataIDTypeCode/@codeListValue='')"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not($emptyGeoId)"/>
         <xsl:otherwise>
...
<xsl:if test="not($emptyGeoId)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
            ...
            <svrl:text>
               <xsl:text/>
               <xsl:copy-of select="$loc/strings/report.M100/div"/>
               <xsl:text/>
            </svrl:text>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
	  ...
	  <!--RULE -->
<xsl:template match="//che:CHE_MD_FeatureCatalogueDescription" priority="1000" mode="M9">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//che:CHE_MD_FeatureCatalogueDescription"/>
      <xsl:variable name="emptyModelType"
                    select="che:dataModel/che:PT_FreeURL/che:URLGroup/che:LocalisedURL!='' and (not(che:modelType) or che:modelType/che:CHE_MD_modelTypeCode/@codeListValue='')"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not($emptyModelType)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                test="not($emptyModelType)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
...
<xsl:if test="not($emptyModelType)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
            ...
            <svrl:text>
               <xsl:text/>
               <xsl:copy-of select="$loc/strings/report.M101/div"/>
               <xsl:text/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
	  ...
	  <!--RULE -->
<xsl:template match="//*[*/@codeListValue]" priority="1000" mode="M10">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//*[*/@codeListValue]"/>
      <xsl:variable name="emptyCodeList" select="*/@codeListValue=''"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not($emptyCodeList)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                test="not($emptyCodeList)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
...
<xsl:if test="not($emptyCodeList)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
            ...
            <svrl:text>
               <xsl:text/>
               <xsl:copy-of select="$loc/strings/report.M102/div"/>
               <xsl:text/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
	  ...
	  <!--RULE -->
<xsl:template match="//gmd:CI_Citation/gmd:title" priority="1000" mode="M11">
...
<xsl:if test="not($emptyTitle)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
            ...
            <svrl:text>
               <xsl:text/>
               <xsl:copy-of select="$loc/strings/report.M103/div"/>
               <xsl:text/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
	  ...
	  <!--RULE -->
<xsl:template match="//gmd:topicCategory" priority="1000" mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//gmd:topicCategory"/>
      <xsl:variable name="code"
                    select="gmd:MD_TopicCategoryCode[              normalize-space(.)='planningCadastre' or              normalize-space(.)='geoscientificInformation' or              normalize-space(.)='imageryBaseMapsEarthCover' or              normalize-space(.)='environment']"/>
      <xsl:variable name="sibling"
                    select="../gmd:topicCategory/gmd:MD_TopicCategoryCode[starts-with(normalize-space(.), concat(normalize-space($code), '_'))]"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="($code and $sibling) or not($code)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                test="($code and $sibling) or not($code)">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
		    ...
		    <!--REPORT -->
<xsl:if test="($code and $sibling) or not($code)">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                 test="($code and $sibling) or not($code)">
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            ...
            <svrl:text>
               <xsl:text/>
               <xsl:copy-of select="$loc/strings/report.M104/div"/>
               <xsl:text/>
            </svrl:text>
         </svrl:successful-report>
      </xsl:if>
