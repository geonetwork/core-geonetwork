					...
					<xsl:when test="$edit=true()">
						<tr type="metadata" id="catalogueTypeSelect">
							...
							<td valign="top" class="padded">
								...
								<select class="md" onchange="document.getElementById('catalogueType').getElementsByTagName('input')[0].value='{$urlPrefix}'+this.options[this.selectedIndex].value.substring(0,this.options[this.selectedIndex].value.indexOf('=')).trim();document.getElementById('catalogueType').getElementsByTagName('input')[1].value=this.options[this.selectedIndex].value;" size="1">
									<option name=""/>
