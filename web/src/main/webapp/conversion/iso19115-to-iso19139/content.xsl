...
<xsl:stylesheet xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gml="http://www.opengis.net/gml"
  ...
  <xsl:template match="*" mode="CovDesc">
    ...
    <contentType>
      <MD_CoverageContentTypeCode codeList="./resources/codeList.xml#MD_CoverageContentTypeCode"
                                  codeListValue="{contentTyp/ContentTypCd/@value}"/>
    </contentType>
  ...
  <xsl:template match="*" mode="ImgDesc">
    ...
    <xsl:for-each select="imagCond">
      <imagingCondition>
        <MD_ImagingConditionCode codeList="./resources/codeList.xml#MD_ImagingConditionCode"
                                 codeListValue="{ImgCondCd/@value}"/>
      </imagingCondition>
    </xsl:for-each>
