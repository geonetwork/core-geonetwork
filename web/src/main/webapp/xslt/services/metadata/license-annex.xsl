...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- TODO not localized - license is in english -->
  <!-- TODO support any record-->
    ...
    <div align="center">
      <xsl:choose>
        ...
        <xsl:otherwise>
          ...
          <b align="center">Agreement to conditions of use at <xsl:value-of
                  select="@currdate"/>, applies to the files listed below.
          </b>
          <br/>
          <br/>
        </xsl:otherwise>
      ...
      <xsl:if test="SecurityConstraints or Constraints or LegalConstraints">
        <fieldset>
          <legend>
            <b>
              <xsl:value-of
                      select="'Additional Constraints on use of the files'"/>
            </b>
          </legend>
          ...
          <tr>
            <td>
              ...
              <i>
                ...
                <br/>
                <xsl:value-of
                        select="concat(city,' ',administrativeArea,' ',postalCode)"/>
                <br/>
      ...
      <fieldset>
        ...
        <table width="75%">
          <tr>
            ...
            <td width="33%">
              <a href="{licenseLink}" target="_blank">Show license (opens a new
                window)
              </a>
            </td>
          </tr>
