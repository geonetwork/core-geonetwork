...
public class UpdateFixedInfoTest extends AbstractServiceIntegrationTest {
    ...
    public void testXLinkedDescriptiveKeywords() throws Exception {
        ...
        assertEqualsText("local://api/registries/vocabularies/keyword?skipdescriptivekeywords=true&thesaurus=local._none_.geocat.ch&id=http%3A%2F%2Fgeocat.ch%2Fconcept%231,http%3A%2F%2Fgeocat.ch%2Fconcept%2320&multiple=true&lang=ger,fre,eng,ita&textgroupOnly=",
            updatedXml,
            "*//gmd:descriptiveKeywords[3]/@xlink:href", XLINK, GCO, GMD);
        assertEqualsText("local://api/registries/vocabularies/keyword?skipdescriptivekeywords=true&thesaurus=external.theme.inspire-service-taxonomy&id=urn%3Ainspire%3Aservice%3Ataxonomy%3AcomGeographicCompressionService&multiple=true&lang=ger,fre,eng,ita&textgroupOnly=",
