...
public class GeonetHarvester extends AbstractHarvester<HarvestResult> {
	...
	protected void doInit(Element node, ServiceContext context)
			throws BadInputEx {
	...
	protected void doUpdate(String id, Element node) throws BadInputEx,
			SQLException {
		...
		// --- we update a copy first because if there is an exception
		// GeonetParams
	...
	protected void storeNodeExtra(AbstractParams p, String path, String siteId,
		...
		settingMan.add("id:" + siteId, "createRemoteCategory",
				params.createRemoteCategory);
