...
class Harvester implements IHarvester<HarvestResult> {
	...
	public HarvestResult harvest(Logger log) throws Exception {
		...
		XmlRequest req = context.getBean(GeonetHttpRequestFactory.class)
				.createXmlRequest(new URL(params.host));
		...
		if (params.useAccount) {
			...
			if (!"true".equals(response.getChild("me").getAttributeValue(
					"authenticated"))) {
	...
	private Set<RecordInfo> search(XmlRequest request, Search s)
	...
	private Element doSearch(XmlRequest request, Search s)
			throws OperationAbortedEx {
	...
	private Map<String, String> buildSources(Element info)
			throws BadServerResponseEx {
	...
	private void retrieveLogo(ServiceContext context, String url, String uuid)
			throws MalformedURLException {
		String logo = uuid + ".gif";

		XmlRequest req = context.getBean(GeonetHttpRequestFactory.class)
				.createXmlRequest(new URL(url));
		Lib.net.setupProxy(context, req);
