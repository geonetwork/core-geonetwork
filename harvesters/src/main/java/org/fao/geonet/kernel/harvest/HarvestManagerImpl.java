...
public class HarvestManagerImpl implements HarvestInfoProvider, HarvestManager {
    ...
    private final List<String> summaryHarvesterSettings = Arrays.asList("harvesting","node","site","name","uuid","url","capabUrl","useAccount","ogctype","options","status","info","lastRun");
