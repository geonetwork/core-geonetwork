...
GeoNetwork.map.EXTENT = new OpenLayers.Bounds(-285401.92, 22598.08, 595401.92,
        903401.92);
GeoNetwork.map.MAXEXTENT = new OpenLayers.Bounds(-285401.92, 22598.08,
        595401.92, 903401.92);

GeoNetwork.map.RESOLUTIONS = [ 3440.64, 1720.32, 860.16, 430.08, 215.04,
        107.52, 53.76, 26.88, 13.44, 6.72, 3.36, 1.68, 0.84 ];

GeoNetwork.map.BACKGROUND_LAYERS = [
        new OpenLayers.Layer.WMS("BRT Achtergrondkaart",
        ...
        new OpenLayers.Layer.WMS("NLR Nederland Aster mosaic",
                "http://gdsc.nlr.nl/wms/aster_all?", {
                    ...
                    isBaseLayer : true,
                    'buffer' : 1
                }), new OpenLayers.Layer('Geen Ondergrond', {
            isBaseLayer : true,
            maxExtent : GeoNetwork.map.MAXEXTENT,
            resolutions : GeoNetwork.map.RESOLUTIONS
        })
// new OpenLayers.Layer.WMS("Background layer", "/geoserver/wms", {layers:
// 'gn:world,gn:ne_50m_boundary_da,gn:ne_50m_boundary_lines_land,gn:ne_50m_coastline',
// format: 'image/jpeg'}, {isBaseLayer: true})
// new OpenLayers.Layer.WMS("Background layer",
// "http://www2.demis.nl/mapserver/wms.asp?", {layers: 'Countries', format:
// 'image/jpeg'}, {isBaseLayer: true})
];
