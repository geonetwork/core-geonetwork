...
GeoNetwork.GeoCatCh.Lang.de = {
	...
	'topicCat' : [
        ...
        [ "biota", "Wald, Flora, Fauna" ],
        [ "boundaries", "Grenzen" ],
        [ "climatologyMeteorologyAtmosphere", "Atmosphäre, Luft, Klima" ],
        [ "economy", "Wirtschaftliche Aktivitäten" ],
        [ "elevation", "Höhen" ],
        [ "environment", "Umwelt-, Naturschutz" ],
        [ "environment_EnvironmentalProtection", "Umweltschutz, Lärm" ],
        [ "environment_NatureProtection", "Natur- und Landschaftsschutz" ],
        [ "geoscientificInformation", "Geowissenschaften, Risiken" ],
        [ "geoscientificInformation_Geology", "Geologie" ],
        [ "geoscientificInformation_Soils", "Boden" ],
        [ "geoscientificInformation_NaturalHazards", "Naturbedingte Risiken" ],
        [ "health", "Gesundheit" ],
        ...
        [ "intelligenceMilitary", "Militär, Sicherheit" ],
        [ "inlandWaters", "Gewässer" ],
        [ "location", "Ortsangaben, Referenzsysteme" ],
        [ "oceans", "Meere" ],
        [ "planningCadastre",
                "Raumplanung, Grundstückkataster" ],
        [ "planningCadastre_Planning",
            "Raumplanung, Raumentwicklung" ],
        [ "planningCadastre_Cadastre",
            "Grundstückkataster" ],
        [ "society", "Bevölkerung, Gesellschaft, Kultur" ],
        [ "structure", "Gebäude, Anlagen" ],
