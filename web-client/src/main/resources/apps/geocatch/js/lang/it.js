...
GeoNetwork.GeoCatCh.Lang.it = {
    ...
    'topicCat' : [
        [ '', '- Qualunque -' ],
        [ "farming", "Agricoltura" ],
        [ "biota", "Bosco, flora, fauna" ],
        [ "boundaries", "Confini" ],
        [ "climatologyMeteorologyAtmosphere", "Atmosfera, climatologia" ],
        [ "economy", "Attività economiche" ],
        [ "elevation", "Altimetria" ],
        [ "environment", "Protezione ambiente e natura" ],
        [ "environment_EnvironmentalProtection", "Protezione ambiente, rumore" ],
        [ "environment_NatureProtection", "Protezione della natura e del paesaggio" ],
        [ "geoscientificInformation", "Geoscienze, rischi" ],
        [ "geoscientificInformation_Geology", "Geologia" ],
        [ "geoscientificInformation_Soils", "Suolo" ],
        [ "geoscientificInformation_NaturalHazards", "Rischi naturali" ],
        [ "health", "Salute" ],
        [ "imageryBaseMapsEarthCover",
            "Carte di base, immagini" ],
        [ "imageryBaseMapsEarthCover_BaseMaps",
            "Carte di base, modelli del territorio" ],
        [ "imageryBaseMapsEarthCover_EarthCover",
            "Copertura e utilizzo del suolo" ],
        [ "imageryBaseMapsEarthCover_Imagery",
            "Immagini aeree e satellitari" ],
        [ "intelligenceMilitary", "Armata, sicurezza" ],
        [ "inlandWaters", "Idrografia" ],
        [ "location", "Localizzazione, sistemi di riferimento" ],
        [ "oceans", "Oceani" ],
        [ "planningCadastre",
        ...
        [ "planningCadastre_Cadastre",
            "Terreni catastali" ],
        [ "society", "Popolazione, società, cultura" ],
        [ "structure", "Edifici, infrastrutture, costruzioni" ],
        [ "transportation", "Trasporto" ],
        [ "utilitiesCommunication",
            "Alimentazione, eliminazione, comunicazione" ]
    ],
