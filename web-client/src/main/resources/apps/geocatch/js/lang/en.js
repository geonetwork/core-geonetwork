...
GeoNetwork.GeoCatCh.Lang.en = {
	...
	'topicCat' : [
        [ '', '- All -' ],
        [ "farming", "Agriculture" ],
        [ "biota", "Forest, Flora, Fauna" ],
        [ "boundaries", "Boundaries" ],
        [ "climatologyMeteorologyAtmosphere", "Atmosphere, climatology" ],
        [ "economy", "Economical Activities" ],
        [ "elevation", "Elevation" ],
        [ "environment", "Environmental and Nature Protection" ],
        [ "environment_EnvironmentalProtection", "Environmental protection, Noise" ],
        [ "environment_NatureProtection", "Nature and Landscape protection" ],
        [ "geoscientificInformation", "Geosciences, Hazards" ],
        [ "geoscientificInformation_Geology", "Geology" ],
        [ "geoscientificInformation_Soils", "Soils" ],
        [ "geoscientificInformation_NaturalHazards", "Natural Hazards" ],
        [ "health", "Health" ],
        [ "imageryBaseMapsEarthCover",
                "Base maps, Imagery" ],
        [ "imageryBaseMapsEarthCover_BaseMaps",
            "Base Maps, Landscape Models" ],
        [ "imageryBaseMapsEarthCover_EarthCover",
            "Land Cover, Land Use" ],
        [ "imageryBaseMapsEarthCover_Imagery",
            "Aerial and Satellite Imagery" ],
        [ "intelligenceMilitary", "Military, Security" ],
        [ "inlandWaters", "Inland waters" ],
        [ "location", "Location, Reference Systems" ],
        [ "oceans", "Oceans" ],
        [ "planningCadastre",
        ...
        [ "society", "Population, Society, Culture" ],
        [ "structure", "Buildings, Infrastructure" ],
