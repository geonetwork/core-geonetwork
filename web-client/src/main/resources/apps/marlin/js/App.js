...
//            }
        ...
        advancedCriteria.push(categoryField,
            spatialTypes,
        ...
        return new Ext.FormPanel({
            ...
            items:[
                // Simple search form and search buttons
                {
                    ...
                    border:false,
                    items:[
                        {html:'<h1>Search MarLIN for</h1>',margins:'5 10 5 10',border:false },
                ...
                //  Advanced search form
                {
                    ...
                    items:[
                        	// MarLIN panel
                        	{
                           		...
                           		layout:'form',
                    					autoHeight: true,
															items: MarLIN.SearchFormTools.getFields(catalogue.services, true)
                        	},
												{
													plain:true,
													layout: {	
...
//                constrain: true,
    ...
    function createHeader(){
        ...
        Ext.getDom('title').innerHTML = '<img class="catLogo" src="images/marlinlogo-300.png" title="'  + info.name + '"/>';
    ...
    return {
        init: function(){
            ...
            // Search map 
            searchMap = GeoNetwork.util.SearchFormTools.getSimpleMap(GeoNetwork.map.BACKGROUND_LAYERS, GeoNetwork.map.MAP_OPTIONS, false)
            ...
            // Search form
            searchForm = createSearchForm(searchMap);
           ...
           var viewport = new Ext.Viewport({
                ...
                items:[   //todo: should add header here?
                    {id:'header',height:90,region:'north',border:false},
                    new Ext.TabPanel({
                        region:'center',
                        id:'GNtabs',
                        deferredRender:false,
