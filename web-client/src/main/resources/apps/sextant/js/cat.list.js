	                        ...
	                        '<tpl for="links">',
	                        	'<tpl if="title">',
		                            ...
		                            '<tpl if="values.type == \'application/zip\' || values.type == \'application/x-compressed\'">',
		                                '<div class="mdHiddenMenu downloadLink" title="' + OpenLayers.i18n('downloadLink') + ' {title}">{title}</div>',
		                            '</tpl>',
		                            '<tpl if="values.type == \'text/html\'">',
		                                '<div class="mdHiddenMenu webLink" title="' + OpenLayers.i18n('webLink') + ' {title}">{title}</div>',
		                            '</tpl>',
		                        '</tpl>',
