...
The quickest way to add relevant data to your catalog is by harvesting. This means copying data from other catalogs into your own catalog. There are many protocols that can be used for harvesting.
