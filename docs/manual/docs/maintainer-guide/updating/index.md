...
=== "Application data directory"
    ...
    2. When using the application data directory, be sure to back up **`/geonetwork/WEB-INF/data/config/encryptor/encryptor.properties`**
...
3. Perform a new install of GeoNetwork 4.0, according to the [installation approach](../../install-guide/index.md) used.

4. Configure GeoNetwork to use your database and data directory.
...
* Note the following changes in application functionality:
   ...
   * [Permalinks to search pages from GeoNetwork 3.x will need to be updated to work with 4.x.](../../user-guide/quick-start/index.md#upgrading-from-geonetwork-3-guidance)
