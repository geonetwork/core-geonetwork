...
-   Monitor the availability of the application using a tool like [Zabbix](https://www.zabbix.com/), [Nagios](https://www.nagios.org/), or [GeoHealthCheck](https://geohealthcheck.org/). The catalogue publishes health check endpoints for this purpose, read more at [Monitoring](../monitoring/index.md).
