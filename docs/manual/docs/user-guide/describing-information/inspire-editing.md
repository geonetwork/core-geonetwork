...
To follow the technical guideline, the catalogue administrator has to setup INSPIRE configuration for the catalogue (see [inspire-configuration](inspire-configuration.md))
...
See [batchupdate_xsl](batchupdate_xsl.md) to preview or apply the process.
