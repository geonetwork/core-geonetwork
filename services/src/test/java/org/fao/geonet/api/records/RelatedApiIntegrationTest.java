...
public class RelatedApiIntegrationTest extends AbstractServiceIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        metadataIndexer.indexMetadata(String.valueOf(parent.getId()), true, IndexingMode.full);
        metadataIndexer.indexMetadata(String.valueOf(child.getId()), true, IndexingMode.full);
    }
