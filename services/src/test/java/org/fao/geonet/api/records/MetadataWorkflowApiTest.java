...
public class MetadataWorkflowApiTest  extends AbstractServiceIntegrationTest {
    ...
    private void createTestData() throws Exception {
        ...
        StatusValue statusValue = statusValueRepository.findOneById(Integer.parseInt(StatusValue.Status.DRAFT));
        ...
        id = dataManager.insertMetadata(context, metadata2, sampleMetadataXml, false, true, false, UpdateDatestamp.NO,
            false, false).getId();
        ...
        statusValue = statusValueRepository.findOneById(Integer.parseInt(StatusValue.Status.APPROVED));
        metadataStatus.setStatusValue(statusValue);
        metadataStatusRepo.save(metadataStatus);
