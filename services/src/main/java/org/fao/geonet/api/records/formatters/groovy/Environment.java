...
public interface Environment extends CurrentLanguageHolder {
     ...
     */
    FormatterWidth getEmbeddingWidth();

    /**
     * Return the map of all parameters passed to the Format service.
     */
    Multimap<String, ParamValue> params();
     ...
     */
    ParamValue param(String paramName);

    /**
     * Return ALL values of parameter with the provided name.
     */
    Collection<ParamValue> paramValues(String paramName);
     ...
     */
    Element getMetadataElement();

    /**
     * Returns the data in the index for the current metadata.
     */
    Map<String, Collection<String>> getIndexInfo() throws Exception;
