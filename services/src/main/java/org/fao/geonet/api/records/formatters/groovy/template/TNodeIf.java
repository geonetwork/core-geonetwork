 ...
 * <p/>
 * In this case truthy means, non-null, non-empty (if string, collection, array or map), a number !=
 * 0 or true value.
 * <p/>
 ...
 * </code></pre>
 * the div will be rendered if there is a value "key" in the model that is a string or Iterable that
 * is non-empty.
 *
