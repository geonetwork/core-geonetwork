...
/**
 * Utilities to convert Entities to DTOs
 * and to calculate AVG in ratings.
 */
public class UserFeedbackUtils {
  ...
  public class RatingAverage {
     ...
     *
     * @param avgFINDABILITY
     *          the new avg FINDABILITY
     */
     ...
     *
     * @param avgREADABILITY
     *          the new avg READABILITY
     */
