...
public class ReplaceReport extends Report {
    ...
    public ReplaceReport(List<Element> changes) {
        ...
        elementChanges = new ArrayList<ReplaceEntryChange>();
        if (changes != null) {
            for (Element change : changes) {
                ReplaceEntryChange elementChange =
                    new ReplaceEntryChange(
                        change.getChildText("fieldid"),
                        change.getChildText("originalval"),
                        change.getChildText("changedval"));
