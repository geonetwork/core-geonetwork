...
public class AnonymousAccessLinkPublishListener implements ApplicationListener<MetadataPublished> {
    @Autowired
    ...
    public synchronized void onApplicationEvent(MetadataPublished event) {
        anonymousAccessLinkService.deleteAnonymousAccessLink(event.getMd().getUuid());
    }
