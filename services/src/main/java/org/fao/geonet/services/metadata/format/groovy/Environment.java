...
public interface Environment extends CurrentLanguageHolder {
    ...
    /**
     * The URL to use in the html when accessing resources in the formatter resource package.
     * Simply append the relative path of the resource from the formatter bundle directory.
     */
     ...
     * org.fao.geonet.services.metadata.format.FormatterWidth}
     */
