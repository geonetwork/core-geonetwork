...
/**
 * Class to model a metadata entry change in the massive replace report.
 *
 * @author Jose García
 *
 */
public class MassiveReplaceReportEntryChange {
    ...
    public MassiveReplaceReportEntryChange(String fieldId, String originalVal, String changedVal) {
