...
public interface IResourceDownloadHandler {
     ...
     */
    HttpEntity<byte[]> onDownload(ServiceContext context, NativeWebRequest request, int metadataId,
                                  String fileName, Path file) throws ResourceHandlerException;

    Element onDownloadMultiple(ServiceContext context, Element params, int metadataId,
