 ...
 * <surname></surname>                      Download user surname <name></name> Download user name
 * <email></email>                          Download user mail <profile></profile>
 *    Download user profile <requestername></requestername> Requester name (if using disclaimer and
 * constraints service for downloads (file.disclaimer)) <requestermail></requestermail>
 * Requester email (if using disclaimer and constraints service for downloads (file.disclaimer))
 * <requesterorg></requesterorg> Requester organisation (if using disclaimer and constraints service
 * for downloads (file.disclaimer)) <requestercomments></requestercomments>  Requester comments (if
 * using disclaimer and constraints service for downloads (file.disclaimer))
 * <recordname></recordname> Metadata title <uuid></uuid>                            Metadata UUID
