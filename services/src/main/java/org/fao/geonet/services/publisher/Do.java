...
public class Do implements Service {
	...
	public Element exec(Element params, ServiceContext context)
		...
		String baseUrl = gc.getBean(SettingManager.class).getValue(Geonet.Settings.SERVER_PROTOCOL)
				+ "://" + gc.getBean(SettingManager.class).getValue(Geonet.Settings.SERVER_HOST)
				+ ":" + gc.getBean(SettingManager.class).getValue("system/server/port")
				+ context.getBaseUrl()
