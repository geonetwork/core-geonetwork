...
/**
 * Service to get core metrics for a service: <ul> <li>total number of searches</li> <li>Average
 * searches by day</li> <li>Average searches by month</li> <li>Number of record views</li> </ul>
 */
