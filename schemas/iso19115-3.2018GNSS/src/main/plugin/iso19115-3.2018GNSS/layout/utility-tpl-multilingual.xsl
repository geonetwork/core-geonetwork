...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="get-iso19115-3.2018GNSS-language">
  ...
  <xsl:template name="get-iso19115-3.2018GNSS-other-languages-as-json">
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:variable name="mainLanguage">
            <xsl:call-template name="get-iso19115-3.2018GNSS-language"/>
          </xsl:variable>
  ...
  <xsl:template name="get-iso19115-3.2018GNSS-other-languages">
    <xsl:variable name="mainLanguage">
      <xsl:call-template name="get-iso19115-3.2018GNSS-language"/>
    </xsl:variable>
  ...
  <!-- Template used to return a translation if one found,
    ...
    -->
  <xsl:template name="get-iso19115-3.2018GNSS-localised"
                mode="localised"
  ...
  <xsl:template name="getLangId19115-3.2018GNSS">
    <xsl:param name="langGui"/>
    <xsl:param name="md"/>

    <xsl:call-template name="getLangIdFromMetadata19115-3.2018GNSS">
  ...
  <!-- Get lang #id in metadata PT_Locale section,  deprecated: if not return the 2 first letters
      ...
      -->
  <xsl:template name="getLangIdFromMetadata19115-3.2018GNSS">
    <xsl:param name="md"/>
    <xsl:param name="lang"/>
