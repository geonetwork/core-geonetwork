...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:title xmlns="http://www.w3.org/2001/XMLSchema">Copernicus Marine rules</sch:title>
    ...
    <sch:pattern>
        ...
        <sch:rule
            context="//gmd:MD_Metadata[contains(gmd:metadataStandardName, 'ISO 19139, MyOcean profile')]/gmd:identificationInfo/gmd:MD_DataIdentification">
    ...
    <sch:pattern>
        ...
        <sch:rule
            context="//gmd:MD_Metadata[contains(gmd:metadataStandardName, 'ISO 19139, MyOcean profile')]">
