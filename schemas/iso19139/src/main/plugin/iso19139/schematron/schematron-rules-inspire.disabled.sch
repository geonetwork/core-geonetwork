...
-->
    ...
    <sch:pattern>
        ...
        <sch:rule context="//gmd:MD_DataIdentification|
            ...
            -->
            <sch:let name="inspire-thesaurus-path" value="concat('file:///', $thesaurusDir, '/external/thesauri/theme/inspire-theme.rdf')"/>
            ...
            <sch:assert test="count($inspire-theme) > 0">
                ...
                (<sch:value-of select="$inspire-thesaurus-path"/>)
