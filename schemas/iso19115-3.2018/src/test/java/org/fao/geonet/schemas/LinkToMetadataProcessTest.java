...
public class LinkToMetadataProcessTest extends XslProcessTest {
    ...
    public void testAddOneSource() throws Exception {
        ...
        assertThat(result, hasXPath("count(//mrl:source)", equalTo("1")).withNamespaceContext(ns));
        assertThat(result, hasXPath("count(//mrl:source[@uuidref = 'uuid-a'][@xlink:title = 'Record A'])",
    ...
    public void testAddSeveralSources() throws Exception {
        ...
        assertThat(result, hasXPath("count(//mrl:source)", equalTo("2")).withNamespaceContext(ns));
        assertThat(result, hasXPath("count(//mrl:source[@uuidref = 'uuid-a'][@xlink:title = 'Record A'])",
            equalTo("1")).withNamespaceContext(ns));
        assertThat(result, hasXPath("count(//mrl:source[@uuidref = 'uuid-b'][@xlink:href = 'http://remote/b'])",
            equalTo("1")).withNamespaceContext(ns));
    }
    ...
    public void testAddOneFeatureCatalogue() throws Exception {
        ...
        assertThat(result, hasXPath("count(//mrc:featureCatalogueCitation)",
            equalTo("1")).withNamespaceContext(ns));
        assertThat(result, hasXPath(
            "count(//mrc:featureCatalogueCitation[@uuidref = 'uuid-a'][@xlink:title = 'Catalogue A'])",
            equalTo("1")).withNamespaceContext(ns));
    }
    ...
    public void testAddSeveralFeatureCatalogues() throws Exception {
        ...
        assertThat(result, hasXPath(
            ...
            equalTo("1")).withNamespaceContext(ns));
        assertThat(result, hasXPath(
            "count(//mrc:featureCatalogueCitation[@uuidref = 'uuid-b'][@xlink:href = 'http://remote/b'])",
            equalTo("1")).withNamespaceContext(ns));
    }
    ...
    public void testSeparatorsInTitleAndUrlAreRestored() throws Exception {
        ...
        assertThat(sources, hasXPath(
            "count(//mrl:source[@uuidref = 'uuid-a']"
                + "[@xlink:title = 'Roads, bridges #2 & 100% fun']"
                + "[@xlink:href = 'http://remote/a?x=1,2#frag'])",
            equalTo("1")).withNamespaceContext(ns));
        assertThat(sources, hasXPath(
            "count(//mrl:source[@uuidref = 'uuid-b'][@xlink:title = 'A%2CB%23C'])",
            equalTo("1")).withNamespaceContext(ns));
        ...
        assertThat(fcats, hasXPath(
            "count(//mrc:featureCatalogueCitation[@uuidref = 'uuid-a']"
                + "[@xlink:title = 'Roads, bridges #2 & 100% fun']"
                + "[@xlink:href = 'http://remote/a?x=1,2#frag'])",
            equalTo("1")).withNamespaceContext(ns));
        assertThat(fcats, hasXPath(
            "count(//mrc:featureCatalogueCitation[@uuidref = 'uuid-b']"
