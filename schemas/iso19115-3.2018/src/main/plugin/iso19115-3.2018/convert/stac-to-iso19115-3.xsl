    ...
    <mdb:MD_Metadata>
      ...
      <mdb:identificationInfo>
        <mri:MD_DataIdentification>
          ...
          <xsl:choose>
            <xsl:when test="contacts or contact or providers">
              <!-- Process contacts from STAC contacts extension (list) -->
              <xsl:for-each select="contacts">
                <mri:pointOfContact>
                  <cit:CI_Responsibility>
                    <cit:role>
              ...
              <!-- Process single contact object for resource contact if present -->
              <xsl:if test="contact">
                <mri:pointOfContact>
                  <cit:CI_Responsibility>
                    <cit:role>
              ...
              <!-- Process remaining contacts without explicit roles -->
              <xsl:for-each select="contacts[not(roles)]">
                <mri:pointOfContact>
                  <cit:CI_Responsibility>
                    <cit:role>
                      <cit:CI_RoleCode codeList="codeListLocation#CI_RoleCode" codeListValue="pointOfContact"/>
