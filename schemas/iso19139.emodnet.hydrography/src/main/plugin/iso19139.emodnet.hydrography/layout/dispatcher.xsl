...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="dispatch-iso19139.emodnet.hydrography">
    ...
    <xsl:apply-templates mode="mode-iso19139.emodnet.hydrography" select="$base"/>
  </xsl:template>
  ...
  <xsl:template mode="mode-iso19139.emodnet.hydrography" match="*|@*">
  ...
  <xsl:template name="get-iso19139.emodnet.hydrography-other-languages">
  ...
  <xsl:template name="get-iso19139.emodnet.hydrography-extents-as-json">
    <xsl:call-template name="get-iso19139-extents-as-json"/>
  </xsl:template>

  <xsl:template name="get-iso19139.emodnet.hydrography-online-source-config">
