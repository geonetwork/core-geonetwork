        ...
        <gmd:graphicOverview>
            <gmd:MD_BrowseGraphic>
                <gmd:fileName>
                    ...
                    <xsl:variable name="metadataId"   select="/root/gmd:MD_Metadata/geonet:info/id/text()" />
                    ...
                    <gco:CharacterString>
                        <xsl:value-of select="$serverPrefix"/><xsl:text>id=</xsl:text><xsl:value-of select="$metadataId" /><xsl:text>&amp;fname=</xsl:text><xsl:value-of select="/root/env/file"/>
                    </gco:CharacterString>
                </gmd:fileName>
