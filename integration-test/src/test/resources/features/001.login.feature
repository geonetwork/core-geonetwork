Feature: GeoNetwork Login
  ...
  Scenario: I login with valid admin credential
    ...
    And I wait 2 seconds for element having css "li.signin-dropdown" to display
    ...
    And I wait 20 seconds for element having css ".gn-user-info" to display
  ...
  Scenario: I login with invalid credential
    ...
    And I click on element having css "form[name=gnSigninForm] button[type=submit]"
    And I wait 20 seconds for element having xpath "//p[@data-ng-show='signinFailure']" to display
