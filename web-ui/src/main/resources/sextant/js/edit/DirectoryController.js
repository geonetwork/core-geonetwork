  ...
  module.controller("GnDirectoryController", [
    ...
    function (
      ...
      $scope.convertToTemplate = function (e) {
        ...
        gnMetadataManager
          .copy(e.id, $scope.ownerGroup, fullPrivileges, "TEMPLATE_OF_SUB_TEMPLATE")
          .then(refreshEntriesInfo);
      };
      ...
      $scope.createFromTemplate = function (e) {
        ...
        gnMetadataManager
          .copy(e.uuid, $scope.ownerGroup, fullPrivileges, "SUB_TEMPLATE")
      ...
      $scope.startImporting = function (asTemplate) {
        ...
        $scope.importData = {
          metadataType: asTemplate ? "TEMPLATE_OF_SUB_TEMPLATE" : "SUB_TEMPLATE",
