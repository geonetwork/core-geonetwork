 ...
 * ```
 */
angular.module('gettext').directive('gettexttranslate', ["gettextCatalog", "$parse", "$animate", "$compile", "$window", function (gettextCatalog, $parse, $animate, $compile, $window) {
 ...
 */
angular.module('gettext').filter('gettexttranslate', ["gettextCatalog", function (gettextCatalog) {
