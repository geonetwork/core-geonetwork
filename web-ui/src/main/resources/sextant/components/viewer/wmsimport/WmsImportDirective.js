...
(function () {
          ...
          function ($scope) {
            ...
            this.addLayer = function (getCapLayer, style) {
              ...
              if ($scope.format == "wms") {
                ...
                gnViewerSettings
                  .getPreAddLayerPromise(layer)
                  .then($scope.map.addLayer(layer));
                return layer;
  ...
  module.directive("gnKmlImport", [
    ...
    function ($translate, olDecorateLayer, gnAlertService, kmlimportTemplateURL) {
      return {
        restrict: "A",
        replace: true,
  ...
  module.directive("gnCapTreeCol", [
    function () {
      return {
        ...
        template:
          "<ul class='list-group'><gn-cap-tree-elt " +
