        ...
        link: function (scope, element, attrs, ctrl) {
          ...
          function getDataModelLabel(fieldId) {
            for (var j = 0; j < scope.md.attributeTable.length; j++) {
              if (fieldId == scope.md.attributeTable[j].name) {
                ...
                function mergeNodeArrays(newTreeNodes, oldTreeNodes) {
                  ...
                  for (i = 0; i < newTreeNodes.length; i++) {
                    ...
                    if (Array.isArray(newNode.nodes)) {
                      newNodeCopy.nodes =
                        oldNode && Array.isArray(oldNode.nodes)
          ...
          function ($attrs, $element) {
            ...
            this.toggleClickOnAllChildren = function (node, unselect) {
              if (node.nodes) {
                ...
                this.treeCtrl.wfsFilterCrl.onCheckboxClick(
                  this.treeCtrl.field,
                  {
                    value: node.key
                  },
