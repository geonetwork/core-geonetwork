...
(function () {
  ...
  module.directive("gnWmtsDownload", [
    "gnWmtsService",
    "gnGlobalSettings",
    "gnSearchSettings",
    "$rootScope",
      ...
      return {
        ...
        link: function (scope, element, attrs, ctrls) {
            ...
            try {
              ...
              scope
                ...
                .then(
                  function () {
                    if (
                      scope.capabilities.Layer &&
                      scope.capabilities.Layer.length != 0
                    ) {
                      scope.isWmtsAvailable = true;
                      scope.isLayerInCapabilities = gnWmtsService.isLayerInCapabilities(
                        scope.capabilities,
                        scope.layerName
                      );
                    }
          ...
          scope.checkWmtsUrl = function () {
            return gnWmtsService.getCapabilities(scope.url).then(function (capabilities) {
