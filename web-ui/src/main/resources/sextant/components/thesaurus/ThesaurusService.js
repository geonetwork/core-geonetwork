...
(function () {
  goog.provide("sx_thesaurus_service");
    ...
    this.$get = [
      ...
      function (
        ...
        var getUILangs = function () {
          ...
          // SEXTANT CHECK
          var currentUILang2_3char = gnCurrentEdit.allLanguages
            ? gnCurrentEdit.allLanguages.iso2code[currentUILang_3char]
            : {};
          if (currentUILang2_3char && currentUILang2_3char.replace) {
          ...
          if (gnLangs.langs[currentUILang_3char]) {
            ...
            if (!_.contains(result, v)) result.push(v);
          }
        ...
        return {
          ...
          getKeywords: function (filter, thesaurus, lang, max, typeSearch) {
            var defer = $q.defer();
            var code2iso = gnCurrentEdit.allLanguages
              ? gnCurrentEdit.allLanguages.code2iso
              : {};
            var allLangs = _.map(Object.keys(code2iso), function (k) {
              return k.replace("#", "");
            }).join(",");
