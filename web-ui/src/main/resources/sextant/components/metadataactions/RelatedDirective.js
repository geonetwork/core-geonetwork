    ...
    function (
      ...
      return {
        ...
        link: function (scope, element, attrs, controller) {
                  ...
                  angular.forEach(data, function (value, idx) {
                    ...
                    if (scope.relations.siblings && scope.relations.associated) {
                      for (var i = 0; i < scope.relations.associated.length; i++) {
                        if (
                          scope.relations.siblings.filter(function (e) {
                    ...
                    if (scope.relations.siblings && scope.siblingsByType) {
                      var types = scope.relations.siblings
                        .map(function (r) {
                        ...
                        .sort()
                        .reverse(); // to handle last empty type
          ...
          if (
            gnSearchSettings.displayChildrenBtn === undefined ||
