    ...
    function (gnRelatedResources, gnConfigService) {
      return {
        ...
        templateUrl: function (elem, attrs) {
          return (
            attrs.template ||
            "../../sextant/components/metadataactions/partials/relatedContainer.html"
          );
        },
        scope: {
  ...
  module.directive("gnRelatedList", [
    ...
    function (gnRelatedResources) {
      return {
        restrict: "A",
        templateUrl:
          "../../sextant/components/metadataactions/partials/relatedSimpleList.html",
        scope: {
          md: "=gnRelatedList",
          user: "=",
          title: "@?"
  ...
  module.directive("gnRelatedEditorList", [
    ...
    function (gnRelatedResources, $rootScope) {
      return {
        restrict: "A",
        templateUrl:
          "../../sextant/components/metadataactions/partials/relatedEditorList.html",
        scope: {
  ...
  module.directive("gnRelatedDropdown", [
    ...
    function (gnRelatedResources) {
      return {
        restrict: "A",
        templateUrl:
          "../../sextant/components/metadataactions/partials/relatedDropdown.html",
        scope: {
  ...
  module.directive("gnRecordIsReplacedBy", [
    ...
    function ($http, Metadata) {
      return {
        restrict: "A",
        templateUrl:
          "../../sextant/components/metadataactions/partials/relatedReplacedBy.html",
        scope: {
    ...
    function ($rootScope) {
      return {
        ...
        templateUrl: function (elem, attrs) {
          return (
            attrs.template ||
            "../../sextant/components/metadataactions/partials/recordsFilters.html"
          );
        },
        scope: {
          agg: "=",
    ...
    function () {
      return {
        ...
        templateUrl: function (elem, attrs) {
          return (
            attrs.template ||
            "../../sextant/components/metadataactions/partials/relatedWithStats.html"
          );
        },
        scope: {
    ...
    function () {
      return {
        ...
        templateUrl: function (elem, attrs) {
          return (
            attrs.template ||
            "../../sextant/components/metadataactions/partials/metadataCard.html"
          );
        },
        scope: {
          md: "=",
    ...
    function (gnRelatedResources) {
      return {
        ...
        templateUrl: function (elem, attrs) {
          return (
            attrs.template ||
            "../../sextant/components/metadataactions/partials/recordLinksButton.html"
          );
        },
        scope: {
    ...
    function (gnRelatedResources, gnRelatedService) {
      return {
        ...
        templateUrl: function (elem, attrs) {
          return (
            attrs.template ||
            "../../sextant/components/metadataactions/partials/recordLinkButton.html"
          );
        },
        scope: {
    ...
    function (Metadata, gnRelatedService) {
      return {
        ...
        templateUrl: function (elem, attrs) {
          return (
            attrs.template ||
            "../../sextant/components/metadataactions/partials/recordsTable.html"
          );
        },
        scope: {
