  ...
  class extends HTMLElement {
    constructor() {
      ...
      function getTemplate(document, baseUrl, portal, uiConfig) {
        ...
        css.setAttribute("href", baseUrl + "/static/gn_search_sextant.css");
        ...
        script.textContent = "" +
          ...
          "  [\"" + baseUrl + "/static/gn_search_sextant.js\"].forEach(function(src) {\n" +
          "    var script = document.createElement(\"script\");\n" +
          ...
          "      }]);" +
          "angular.bootstrap(root, ['gn_search_sextant']);" +
          "};" +
          "";
        app.appendChild(script);
