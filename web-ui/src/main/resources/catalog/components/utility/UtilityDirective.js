    ...
    function($http) {
      return {
        ...
        template: '<svg xmlns="http://www.w3.org/2000/svg" ' +
          ...
          '             viewBox="0 0 500 500">' +
          '    <defs>' +
          '      <pattern id="image{{escape(org)}}" x="0" y="0" patternUnits="userSpaceOnUse" height="100%" width="100%">' +
          '        <image ng-if="hasIcon" x="0" y="0" height="100%" width="100%" xlink:href="{{\'../../images/harvesting/\' + org + \'.png\'}}"></image>' +
          '      </pattern>' +
          '    </defs>' +
          '    <circle fill="url(\'#image{{escape(org)}}\')" style="stroke-miterlimit:10;" cx="250" cy="250" r="240"/>' +
          '    <text x="50%" y="50%"' +
