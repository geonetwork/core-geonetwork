                  ...
                  'iso19115-3.2018': {
                    ...
                    types: [{
                      ...
                      fields: {
                        'url': {isMultilingual: false},
                        'protocol': {
                          value: 'NETWORK:LINK', hidden: true,
                          isMultilingual: false
                        },
                        'name': {},
                        'desc': {},
                      ...
                      fields: {
                        'url': {isMultilingual: false},
                        'protocol': {value: 'FTP', hidden: true,
                          isMultilingual: false},
                        'name': {},
                        'desc': {},
                        'function': {value: 'download', hidden: true,
                      ...
                      fields: {
                        'url': {isMultilingual: false},
                        'protocol': {value: 'THREDDS', hidden: true,
                          isMultilingual: false},
                        'name': {},
                        'desc': {},
                        'function': {value: 'download', hidden: true,
                      ...
                      fields: {
                        'url': {isMultilingual: false},
                        'protocol': {value: 'OPENDAP', hidden: true,
                          isMultilingual: false},
                        'name': {},
                        'desc': {},
                        'function': {value: 'browsing', hidden: true,
                      ...
                      fields: {
                        ...
                        'name': {'value': 'Processing and validation'},
                        'desc': {},
                        'function': {value: 'information', hidden: true,
                          isMultilingual: false}
                      }
