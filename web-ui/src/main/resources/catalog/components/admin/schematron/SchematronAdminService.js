(function () {
    ...
    module.service('gnSchematronAdminService', ['$http', '$cacheFactory', '$q',
        function ($http, $cacheFactory, $q) {
            var TIMEOUT, cache, getDataFromCache, putDataIntoCache, removeElementFromCache, groupCacheId, updateCacheOnGroupChange,
                updateCacheOnCriteriaChange, sortByDisplayPriority, findIndex, criteriaComparator, groupComparator;
            ...
            groupCacheId = function(schematronId) { return "criteriaGroup_"+schematronId; };
            ...
            groupComparator = function (o1, o2) {return o1.id.schematronid === o2.id.schematronid && o1.id.name === o2.id.name; };
                ...
                list: function(schematronId, successFunction) {
                    ...
                    if (data) {
                        ...
                        $http({
                            ...
                            alert("Error occurred during loading schematron criteria groups for schematron: " + schematronId);
                        });
                    }
                }
            };
