...
(function () {
  goog.provide("gn_lbn_directive");

  goog.require("gn_popup");

  var module = angular.module("gn_lbn_directive", ["gn_popup"]);
   ...
   */
  module.directive("gnLbn", [
    "$translate",
    function ($translate) {
      return {
        restrict: "A",
        replace: false,
        templateUrl: "../../catalog/components/common/lbn/partials/" + "panel.html",
        scope: {
          id: "=gnLbn"
        },
        link: function (scope) {
