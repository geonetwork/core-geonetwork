...
(function () {
  goog.provide("gn_sharez_directive");

  goog.require("gn_popup");
  goog.require("gn_sharez_service");

  var module = angular.module("gn_sharez_directive", ["gn_sharez_service", "gn_popup"]);

  /**
   * @ngdoc directive
   * @name gn_sharez.directive:gnSharez
   * @restrict A
   * @requires gnSharezService
   * @requires gnSharezConstants
   * @requires $translate
   *
   * @description
   * The `gnSharez` directive provides a form to display,
  ...
  module.directive("gnSharez", [
    ...
    function (
      ...
      return {
        restrict: "A",
        replace: false,
        templateUrl: "../../catalog/components/common/sharez/partials/" + "panel.html",
        scope: {
          id: "=gnSharez",
          batch: "@gnSharezBatch",
          selectionBucket: "@"
