...
(function () {
  goog.provide("gn_sharez_service");

  var module = angular.module("gn_sharez_service", []);

  module.value("gnSharezConstants", {
   ...
   * @ngdoc service
   * @kind function
   * @name gn_sharez.service:gnSharezService
   * @requires gnSharezConstants
   * @requires $q
   * @requires $http
   *
   * @description
   * The `gnSharezService` service provides all tools required to manage
   * privileges on metadata records. Privileges define which type operation
   * (eg. view, download, edit) a group of user can do.
   */
  module.factory("gnSharezService", [
    "$q",
    "$http",
    "gnSharezConstants",
    "gnConfig",
    ...
    function ($q, $http, gnShareConstants, gnConfig, gnUrlUtils) {
      ...
      return {
        /**
         * @ngdoc method
         * @methodOf gn_sharez.service:gnSharezService
         * @name gnSharezService#isAdminOrReviewer
         *
         * @description
         ...
         * @ngdoc method
         * @methodOf gn_sharez.service:gnSharezService
         * @name gnSharezService#loadPrivileges
         *
         * @description
         ...
         * @ngdoc method
         * @methodOf gn_sharez.service:gnSharezService
         * @name gnSharezService#savePrivileges
         *
         * @description
