    ...
    function (gnMap, gnMapsManager, olDecorateInteraction) {
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          scope.mapId = "map-drawbbox-" + mapRef.substring(1, mapRef.length);
          ...
          var setDcOutput = function () {
            ...
            if (scope.extent.md) {
              scope.extent.md.forEach(function (v, i) {
                if (v != null) {
                  scope.extent.md[i] = v.toFixed(Math.max(2, getPrecision(v)));
                }
              });
            }
          ...
          if (
            ...
            scope.extent.md = [
              parseFloat(attrs.hleft),
              parseFloat(attrs.hbottom),
              parseFloat(attrs.hright),
              parseFloat(attrs.htop)
            ];
          }
