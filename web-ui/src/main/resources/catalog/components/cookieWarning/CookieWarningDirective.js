    ...
    function ($window, $cookies, gnGlobalSettings) {
      return {
        ...
        link: function (scope, element, attrs, ctrl) {
          ...
          scope.cookieWarningMoreInfoLink =
            gnGlobalSettings.gnCfg.mods.cookieWarning.cookieWarningMoreInfoLink;
          scope.cookieWarningRejectLink =
            gnGlobalSettings.gnCfg.mods.cookieWarning.cookieWarningRejectLink;
          ...
          scope.goAway = function () {
            ...
            if (
              scope.cookieWarningRejectLink &&
              scope.cookieWarningRejectLink.trim().length !== 0
            ) {
