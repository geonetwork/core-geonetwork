  ...
  module.directive('searchFilterTags', ['$location', 'gnThesaurusService', '$q', '$cacheFactory', '$browser',
    function ($location, gnThesaurusService, $q, $cacheFactory, $browser) {
      ...
      var hasEmptyValue = function(value) {
        if (!angular.isDefined(value) || value === null || (angular.isString(value) && value.trim() === '')) {
          return true;
        } else {
          return false;
        }
      ...
      var filterKeyIsTaggable = function (filterKey) {
        var filtersNotTaggables = ['bboxes', 'editable', 'fast', 'facet.q', 'from', 'geometry',
          'isChild', 'resultType', 'sortBy', 'sortOrder', '_owner', '_isTemplate',
      ...
      return {
        ...
        templateUrl: '../../catalog/components/search/searchfiltertag/partials/' +
