...
(function() {
  ...
  var module = angular.module('gn_mdview', ['gn_mdview_service',
    'gn_mdview_directive', 'gn_md_feedback', 'gn_userfeedback',
    'gn_thesaurus', 'gn_catalog_service']);
  ...
  module
      .controller(
        ...
        function($scope, $http, $compile, gnSearchSettings,
           gnSearchLocation, gnMetadataActions,
           gnAlertService, $translate, $location,
          ...
          $scope.recordIdentifierRequested = gnSearchLocation
             .getUuid();
          ...
          $scope.deleteRecord = function(md) {
            return gnMetadataActions
               ...
               function(reason) {
                 ...
                 // improvements
                 // See
                 // https://github.com/geonetwork/core-geonetwork/issues/723
                 gnAlertService
                 .addAlert({
                   msg: reason.data,
                   type: 'danger'
          ...
          // in default mode.
          $scope.$watch('mdView.current.record',
                  function() {
                    $scope.usingFormatter = false;
