(function() {
  ...
  module.controller('GnFormatterViewer', ['$scope', '$http', '$sce', '$routeParams',
    function($scope, $http, $sce, $routeParams) {
      ...
      $http.get('md.format.xml?xsl='+formatter+'&id=' + mdId).success(function(data) {
  ...
  module.config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider.when('/:formatter/:mdId', { templateUrl: tpls + '/formatter-viewer.html', controller: 'GnFormatterViewer'});
  }])
})();
