(function () {
  ...
  module.directive('sxtCategoryTree', [
    ...
    return {
      restrict: 'A',
      template: '<gn-categorytree-col class="list-group" collection="member.nodes"></gn-categorytree-col>',
  ...
  module.directive('gnCategorytreeCol', [
    function () {
      return {
        ...
        template: "<ul class='collapsed'><gn-categorytree-elt ng-repeat='member in collection' member='member'></gn-categorytree-elt></ul>"
      }
    }]);
      ...
      return {
        ...
        link: function (scope, element, attrs, controller) {
          ...
          if (angular.isArray(scope.member.nodes)) {
            element.append("<gn-categorytree-col class='list-grou' collection='member.nodes' map='map'></gn-categorytree-col>");
