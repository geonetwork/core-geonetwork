(function() {
  ...
  module.directive('sxtMdManageActionsMenu', ['gnMetadataActions', '$http',
    ...
    function(gnMetadataActions, $http, $location, Metadata, sxtService, gnConfig) {
      return {
        ...
        templateUrl: '../../catalog/views/sextant/directives/' +
          'partials/mdmanageactionmenu.html',
        link: function linkFn(scope, element, attrs) {
          scope.md = scope.$eval(attrs.sxtMdManageActionsMenu);
          scope.tasks = [];
          scope.doiDefined = scope.md.getLinksByType("DOI", "WWW:LINK-1.0-http--metadata-URL").length > 0;
