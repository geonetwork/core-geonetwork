...
(function () {
  goog.provide("sx_checkbox_with_nilreason");
    ...
    function (
      ...
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          scope.radioLabels = attrs.labels
            ? angular.fromJson(attrs.labels)
          ...
          function build() {
            ...
            var booleanXmlSnippet = isNil
              ? ""
              : "<" + booleanElement + ">" + scope.status + "</" + booleanElement + ">";
