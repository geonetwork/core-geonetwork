...
(function () {
  goog.provide("sx_directoryassociatedmd_directive");

  goog.require("sx_mdtypewidget");
  goog.require("sx_mdtypeinspirevalidationwidget");
  goog.require("sx_draftvalidationwidget");
  goog.require("sx_batchtask");
