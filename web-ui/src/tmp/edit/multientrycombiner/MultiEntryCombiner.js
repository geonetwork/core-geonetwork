...
(function () {
  goog.provide("sx_multientry_combiner");

  var module = angular.module("gn_multientry_combiner", ["pascalprecht.translate"]);

  module.directive("gnMultientryCombiner", [
    "gnCurrentEdit",
    "gnGlobalSettings",
    "gnLangs",
    function (gnCurrentEdit, gnGlobalSettings, gnLangs) {
      return {
        ...
        link: function (scope, element, attrs) {
          ...
          // will be "eng" or "fra"
          scope.currentUILang = gnCurrentEdit.allLanguages.iso2code[
