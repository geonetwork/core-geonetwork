...
(function () {
  "use strict";
  goog.provide("sx_schematronadmin_editcriteriadirective");
  goog.require("sx_schematronadminservice");
      ...
      return {
        ...
        link: function (scope, element) {
          ...
          scope.isDirty = function () {
            return (
              scope.criteria.uitype !== scope.original.uitype ||
          ...
          scope.deleteCriteria = function () {
            scope.confirmationDialog.message = $translate.instant(
              "confirmDeleteSchematronCriteria"
            );
          ...
          scope.saveEdit = function () {
            ...
            if (scope.isDirty()) {
              ...
              if (scope.criteria.id) {
                // it is an updated
                gnSchematronAdminService.criteria.update(
                  scope.criteria,
                  scope.original,
                  scope.group
                );
                ...
                // it is an add
                gnSchematronAdminService.criteria.add(
                  scope.criteria,
                  scope.original,
                  scope.group
                );
          ...
          scope.updateTypeAhead = function () {
            var input, criteriaType, source, typeaheadOptions, parseResponseFunction;
