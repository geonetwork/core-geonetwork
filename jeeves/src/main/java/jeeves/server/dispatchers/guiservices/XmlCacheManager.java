...
public class XmlCacheManager {
    ...
    public synchronized Element get(ServletContext servletContext, boolean localized, String base, String file, String preferedLanguage, String defaultLang) throws JDOMException, IOException {

        Map<String, XmlFileCacher> cacheMap = getCacheMap(localized, base, file);

        final ServletPathFinder pathFinder = new ServletPathFinder(servletContext);
        String appPath = pathFinder.getAppPath(); //context.getAppPath();
        String xmlFilePath;
