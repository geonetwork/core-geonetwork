...
public final class DBUtils {
    ...
    /**
     * Default constructor. Builds a DBUtils.
     */
    private DBUtils() {
    }

    public static Vector<Object> scanInFields(Element params, Vector<Element> inFields, Element result, ApplicationContext context) throws Exception {
        // build argument list
     ...
     */
    public static Element select(ApplicationContext context, String query)
            throws SQLException {
         ...
         * all JPA database access.
         */
        public static Element selectFull(ApplicationContext context, String query, Map<String, String> formats, Object... args)
                throws SQLException {
