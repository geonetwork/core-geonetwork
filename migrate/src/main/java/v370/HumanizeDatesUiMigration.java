...
/**
 * Adds a new section <code>mods.global</code> to <code>ui/config</code> setting to enable
 * a global options module and <code>mods.global.humanizeDates</code> to enable the use of
 * humanized dates (i.e "3 days ago").
 */
public class HumanizeDatesUiMigration extends JsonDatabaseMigration {
